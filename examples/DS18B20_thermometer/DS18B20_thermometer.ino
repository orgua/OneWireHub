...
auto ds18s20 =
        DS18B20(0x10, 0x00, 0x00, 0xA2, 0x18, 0xDA, 0x00); // DS18S20: 9   bit, -55 -  +85 degC
auto ds1822 =
        DS18B20(0x22, 0x00, 0x00, 0x22, 0x18, 0xDA, 0x00); // DS1822:  9-12bit, -55 - +125 degC
...
void setup()
{
    ...
    Serial.print(", ");
    Serial.println(
            ds18s20.getTemperature()); // ds18s20 is limited to signed 9bit, so it could behave different
