...
DS2434::DS2434(uint8_t ID1, uint8_t ID2, uint8_t ID3, uint8_t ID4, uint8_t ID5, uint8_t ID6,
               uint8_t ID7)
...
bool DS2434::getTemperatureRequest() const { return (request_temp); }

void DS2434::lockNV1() { memory[0x62] |= 0b100u; }

void DS2434::unlockNV1() { memory[0x62] &= ~0b100u; }

void DS2434::setBatteryCounter(uint16_t value) { *((uint16_t *) &memory[0x82]) = value; }

void DS2434::setID(uint16_t value) { *((uint16_t *) &memory[0x80]) = value; }
