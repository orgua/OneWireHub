...
private:
    ...
    static constexpr uint8_t REG_SEARCH_MASK{
            3}; // 0x8B - RW Conditional Search Channel Selection Mask
    static constexpr uint8_t REG_SEARCH_SELECT{
            4}; // 0x8C - RW Conditional Search Channel Polarity Selection
...
public:
    ...
    DS2408(uint8_t ID1, uint8_t ID2, uint8_t ID3, uint8_t ID4, uint8_t ID5, uint8_t ID6,
           uint8_t ID7);
