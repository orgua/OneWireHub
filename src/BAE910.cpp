...
BAE910::BAE910(uint8_t ID1, uint8_t ID2, uint8_t ID3, uint8_t ID4, uint8_t ID5, uint8_t ID6,
               uint8_t ID7)
    : OneWireItem(ID1, ID2, ID3, ID4, ID5, ID6, ID7)
{
    ...
    static_assert(
            sizeof(sBAE910) <= BAE910_MEMORY_SIZE,
            "Memory-struct is larger than its memory"); // not needed anymore, but not hurting either
