...
DS2433::DS2433(uint8_t ID1, uint8_t ID2, uint8_t ID3, uint8_t ID4, uint8_t ID5, uint8_t ID6,
               uint8_t ID7)
...
void DS2433::duty(OneWireHub *const hub)
{
    ...
    switch (cmd)
    {
        ...
        case 0x55: // COPY SCRATCHPAD
            ...
            while (!hub->send(&ALTERNATE_01))
                ; // send alternating 1 & 0 after copy is complete
            break;
