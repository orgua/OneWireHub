...
constexpr uint8_t MemDS2438[64] = {
        ...
        0x09, 0x20, 0x14, 0xAC, 0x00, 0x40, 0x01, 0x00, 0xEC, 0xAB, 0x23, 0x58, 0xFF,
        0x08, 0x00, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x6D, 0x83, 0x03, 0x02, 0x00, 0x00,
...
public:
    ...
    DS2438(uint8_t ID1, uint8_t ID2, uint8_t ID3, uint8_t ID4, uint8_t ID5, uint8_t ID6,
           uint8_t ID7);
