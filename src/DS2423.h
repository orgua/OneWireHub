...
private:
    ...
    static constexpr uint8_t COUNTER_PAGE_START{
            12}; // page 12&13 have write-counters, page 14&15 transmit the hw-counters
...
public:
    ...
    DS2423(uint8_t ID1, uint8_t ID2, uint8_t ID3, uint8_t ID4, uint8_t ID5, uint8_t ID6,
           uint8_t ID7);
